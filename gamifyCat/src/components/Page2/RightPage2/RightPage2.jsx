  ...
  return (
    <>
     ...
     className='h-[80vh]  flex justify-between items-end  p-5 text-white w-full rounded-3xl'>
         ...
         <button className='py-3 px-6 border-2 border-white rounded-full text-base font-semibold '>Game Design</button>
         <button className='py-3 px-6 border-2 border-white rounded-full text-base font-semibold  '>Web Design & Development</button>
         </div>
