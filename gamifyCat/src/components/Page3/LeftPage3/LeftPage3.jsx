    ...
    return (
        <>
            <div className='w-ful lg:w-1/2 flex flex-col justify-center h-fit py-20 lg:py-0 lg:h-screen gap-10  text-start px-28' >
                <h1 className='text-7xl font-semibold '>We're <br /> trustworthy</h1>
                <p className='text-base'>Trusted by over 100 advertising agencies, companies, media digital magazines and brands</p>
                <button
                    className='
                        w-fit
                        py-2 
